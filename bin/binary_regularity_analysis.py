...
from utils.stat_utils import calculate_binary_stats, get_stat_names
from utils.time_utils import get_timedeltas
from utils.data_utils import *

def calculate_user_binary_regularity(config_file, verbose=2):
    """
    ...
    stat_types = get_stat_names(experiments, ex_type="Binary")
    ...
    results = login_dataframe.groupby("CUST_CODE").parallel_apply(calculate_binary_stats, **kwds)
    end = time.time()
    ...
    filename = output_dir + "binary_regularity_results" + "_" + freq + "_" + mode + data_ext
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config_file", default="cfg/binary_regularity.config.yml", help="yaml config file for statistical calculation")
    ...
    calculate_user_binary_regularity(args.config_file, args.verbose)